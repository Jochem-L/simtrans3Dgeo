...
1. Original polynomial transformation from Bonne coordinates to RD ([EPSG:28992](https://epsg.org/crs_28992/Amersfoort-RD-New.html "EPSG:28992 in official EPSG website"))
...
The residuals of the approximate similarity transformation reach up to 6 m and show a whirly pattern that is typical for the inaccuracies of a triangulation [Figure](residuals_7par.png "Residuals of approximate similarity transformation at 68 common points"). For the original polynomial transformation, the residuals are smaller [Figure](residuals_poly.png "Residuals of original polynomial transformation at 68 common points"). However, the pattern and magnitude of the residuals are only representative for high-order triangulated points. The deviations of topographic features in the historical maps can be much larger (e.g. RMSE of 74 m for a sample of 32 points in the municipality Dieren)<sup>[[TKL 1925, p.55](https://dehollandsecirkel.courant.nu/periodicals/TKL/1925)]</sup> for both transformations.
